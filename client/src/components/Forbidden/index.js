        ...
        <div className={`${classes.bodyStyle} ${classes.allStyle}`}>
            <use>
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    xmlSpace="preserve" className={`${classes.whistle}`}>
            ...
            <h1 className={classes.h1Style}>403</h1>
            <h2 className={classes.h2Style}>Not this time, access forbidden!</h2>
            <p className={classes.pStyle}>If you think this is a misunderstanding - please talk to the administrator</p>
        </div>
    )
}
